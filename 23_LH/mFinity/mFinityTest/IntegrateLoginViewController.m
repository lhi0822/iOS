...
- (BOOL) saveFile {
    ...
    if (![fileManager isReadableFileAtPath:mainBgfilePath] || ![fileManager isReadableFileAtPath:subBgfilePath] ||![fileManager isReadableFileAtPath:introfilePath]||![fileManager isReadableFileAtPath:loginBgfilePath]||![fileManager isReadableFileAtPath:iconBgfilePath] || ![fileManager isReadableFileAtPath:lMainBgfilePath] || ![fileManager isReadableFileAtPath:lSubBgfilePath] || ![fileManager isReadableFileAtPath:lIntrofilePath] || ![fileManager isReadableFileAtPath:lLoginBgfilePath]) {
    ...
    NSLog(@"appDelegate.htmlPath : %@", appDelegate.htmlPath);
