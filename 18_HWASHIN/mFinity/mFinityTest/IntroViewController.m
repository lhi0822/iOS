...
- (void)viewDidLoad
{
	...
	if (bgImage == nil) {
		bgImage = [UIImage imageNamed:@"simple_port_intro.png"];
	}
...
//    NSString *mainURL = @"http://svr001.ezsmart.co.kr:1598/dataservice41";
//    [prefs setObject:mainURL forKey:@"URL_ADDRESS"];
//    [prefs synchronize];
    
    NSString *mainURL = @"https://plm.hwashin.co.kr/dataservice41";
//    NSString *mainURL = @"http://roms.dbvalley.com:11598/dataservice41";
    [prefs setObject:mainURL forKey:@"URL_ADDRESS"];
    [prefs synchronize];
