...
- (void)viewDidLoad
{
    ...
    if (appDelegate.isOffLine) {
        ...
        [menuArray addObject:NSLocalizedString(@"message29", @"잠금 설정")];
        [tmpIconArray addObject:@"set_systeminfo.png"];
        [tmpIconArray addObject:@"set_lock.png"];
        ...
        if ([appDelegate.noAuth isEqualToString:@"DEMO"]) {
            ...
            [menuArray addObject:NSLocalizedString(@"message111", @"Off-Line 웹앱 다운로드")];
            ...
            if ([[prefs objectForKey:@"OFFLINE_FLAG"] isEqualToString:@"N"]) {
                ...
                [menuArray addObject:NSLocalizedString(@"message29", @"잠금 설정")];
                [menuArray addObject:NSLocalizedString(@"message38", @"컨텐츠 삭제")];
                [menuArray addObject:NSLocalizedString(@"message110", @"Off-Line 비밀번호 변경")];
                [menuArray addObject:NSLocalizedString(@"message111", @"Off-Line 웹앱 다운로드")];
