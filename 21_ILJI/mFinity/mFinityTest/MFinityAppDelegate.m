    ...
    if (state==UIApplicationStateActive) {
        ...
        if (_isLogin) {
            ...
            if ([type isEqualToString:@"M1"]) {
                ...
                _userInfo = userInfo;
                if (_isLogin) {
                    alertView = [[UIAlertView alloc]initWithTitle:title message:body delegate:self cancelButtonTitle:NSLocalizedString(@"message52", @"message52") otherButtonTitles:NSLocalizedString(@"message51", @"message51"), nil];
                    alertView.tag = 104;
                }else{
                    _receivePush = YES;
        ...
        if ([type isEqualToString:@"M2"]) {
            ...
            _userInfo = userInfo;
            if (_isLogin) {
                UIAlertView *alertView = [[UIAlertView alloc]initWithTitle:title message:body delegate:self cancelButtonTitle:NSLocalizedString(@"message52", @"message52") otherButtonTitles:NSLocalizedString(@"message51", @"message51"), nil];
                alertView.tag = 104;
                [alertView show];
            }else{
                _receivePush = YES;
