...
//                                                                                 style:UIBarButtonItemStylePlain target:self action:@selector(rightSideMenuButtonPressed:)];
    ...
    indicator.center = CGPointMake(self.view.center.x, self.view.center.y-(self.navigationController.navigationBar.frame.size.height+[UIApplication sharedApplication].statusBarFrame.size.height)); //self.view.center;
