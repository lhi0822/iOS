...
{
    //뷰 사이즈 조절
//    NSInteger navBarHeight = self.navigationController.navigationBar.frame.size.height+5;
//    self.view.bounds = CGRectMake(0, -navBarHeight, self.view.frame.size.width, self.view.frame.size.height-(navBarHeight+self.inputToolbar.preferredDefaultHeight));
...
- (NSAttributedString *)collectionView:(JSQMessagesCollectionView *)collectionView attributedTextForMessageDateLabelAtIndexPath:(nonnull NSIndexPath *)indexPath
{
    return nil;
}

- (NSAttributedString *)collectionView:(JSQMessagesCollectionView *)collectionView attributedTextForSystemLabelAtIndexPath:(nonnull NSIndexPath *)indexPath
{
    return nil;
}
...
- (UICollectionViewCell *)collectionView:(JSQMessagesCollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.systemLabel.attributedText = [collectionView.dataSource collectionView:collectionView attributedTextForSystemLabelAtIndexPath:indexPath];
    ...
    if (isOutgoingMessage) {
        ...
        cell.messageBubbleTopLabel.textInsets = UIEdgeInsetsMake(0.0f, bubbleTopLabelInset, 0.0f, 0.0f); //사용자이름위치
    }
...
- (CGFloat)collectionView:(JSQMessagesCollectionView *)collectionView
                   layout:(JSQMessagesCollectionViewFlowLayout *)collectionViewLayout heightForCellMessageDateLabelAtIndexPath:(nonnull NSIndexPath *)indexPath
{
    return 0.0f;
}

- (CGFloat)collectionView:(JSQMessagesCollectionView *)collectionView
                   layout:(JSQMessagesCollectionViewFlowLayout *)collectionViewLayout heightForCellSystemLabelAtIndexPath:(nonnull NSIndexPath *)indexPath
{
    return 0.0f;
}
