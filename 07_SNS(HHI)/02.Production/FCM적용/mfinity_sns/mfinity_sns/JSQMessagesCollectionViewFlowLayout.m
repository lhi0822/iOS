...
const CGFloat kJSQMessagesCollectionViewCellLabelHeightDefault = 20.0f; //사용자이름 기본값 20.0f
const CGFloat kJSQMessagesCollectionViewAvatarSizeDefault = 35.0f; //기본값 30.0f
const CGFloat kJSQMessagesCollectionViewCellLabelDateHeightDefault = 35.0f; //날짜라인
...
- (void)jsq_configureFlowLayout
{
    ...
    _messageBubbleFont = [UIFont systemFontOfSize:15];
...
- (CGSize)sizeForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    finalHeight += attributes.cellSystemLabelHeight;
...
- (void)jsq_configureMessageCellLayoutAttributes:(JSQMessagesCollectionViewLayoutAttributes *)layoutAttributes
{
    ...
    layoutAttributes.cellMessageDateHeight = [self.collectionView.delegate collectionView:self.collectionView
                                                                                   layout:self
                                                      heightForCellMessageDateLabelAtIndexPath:indexPath];
    
    layoutAttributes.cellSystemLabelHeight = [self.collectionView.delegate collectionView:self.collectionView
                                                                                   layout:self
                                                 heightForCellMessageDateLabelAtIndexPath:indexPath];
    
    layoutAttributes.cellSystemLabelHeight = [self.collectionView.delegate collectionView:self.collectionView
                                                                                   layout:self
                                                 heightForCellSystemLabelAtIndexPath:indexPath];
}
