...
#define SINGLE_LOGIN YES         //테스트 시 같은 계정으로 접속하기 위해 NO 로 설정
#define WORKTIME_LIMIT YES       //근로시간 외 사용 제한 여부
...
#define APP_TYPE @"ENT"
//#define DVC_TYPE @"ENT" //운영
#define DVC_TYPE @"DEV" //개발
#define P_SCHEME @""
#define T_SCHEME @""
#define SHARE_EXT_SCHEME @""
...
#define DB_ENCRYPT NO           //로컬DB 암호화 사용 여부
#define WS_ENCRYPT YES          //웹서비스 파라미터 암호화 사용 여부
#define IS_MDM NO               //MDM 사용여부
#define MEDIA_AUTH_CHECK NO     //촬영 및 앨범 접근 권한 제한
#define USE_TASK YES            //프로젝트 게시판 사용 여부
#define AUTO_LOGIN NO           //자동로그인 사용 여부
#define BOARD_INFO_ICON YES     //팀룸목록에 아이콘 표시 여부
#define SIMPLE_PWD NO           //간편비밀번호 사용 여부
#define WORKTIME_LIMIT YES       //근로시간 외 사용 제한 여부
...
- (id)init {
    ...
    if (self) {
        ...
        self.singleLogin = SINGLE_LOGIN;
        self.workTimeLimit = WORKTIME_LIMIT;
