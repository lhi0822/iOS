...
const CGFloat kJSQMessagesLoadEarlierHeaderViewHeight = 0.0f; //기본값 32.0f;
...
+ (UINib *)nib
{
    return [UINib nibWithNibName:NSStringFromClass([JSQMessagesLoadEarlierHeaderView class]) bundle:[NSBundle bundleForClass:[JSQMessagesLoadEarlierHeaderView class]]];
}
