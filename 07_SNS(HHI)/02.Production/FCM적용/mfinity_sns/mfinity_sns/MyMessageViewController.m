...
- (void)callWebService{
    ...
    if([self.fromSegue isEqualToString:@"BOARD_MSG_NAME"]){
        ...
        NSString *paramString = [NSString stringWithFormat:@"usrNo=%@&msg=%@&compNo=%@&dvcId=%@", userNo, msg, compNo, [appDelegate.appPrefs objectForKey:[appDelegate setPreferencesKey:@"DVCID"]]];
