...
+(NSString *)getChatRoutingKey:(NSString *)roomNo{
    AppDelegate *appDelegate = (AppDelegate *)[UIApplication sharedApplication].delegate;
    NSString *routingKey = [NSString stringWithFormat:@"%@.CHAT.%@.%@", [[MFSingleton sharedInstance] appType], [appDelegate.appPrefs objectForKey:@"COMP_NO"], roomNo];
    return routingKey;
}
...
+(UIImage *)saveThumbImage:(NSString *)folder path:(NSString *)thumbFilePath num:(NSString *)paramNo{
    ...
    if(paramNo!=nil){
        savePath = [NSString stringWithFormat:@"%@/%@/%@/%@/%@/", [NSHomeDirectory() stringByAppendingPathComponent:@"Documents"], bundleIdentifier, [appDelegate.appPrefs objectForKey:@"COMP_NO"], folder, paramNo];
        ...
        savePath = [NSString stringWithFormat:@"%@/%@/%@/%@/", [NSHomeDirectory() stringByAppendingPathComponent:@"Documents"], bundleIdentifier, [appDelegate.appPrefs objectForKey:@"COMP_NO"], folder];
    }
