...
- (void)messagesInputToolbar:(JSQMessagesInputToolbar *)toolbar didPressRightBarButton:(UIButton *)sender{
    [self.view endEditing:YES];
    sender.enabled = NO;
    if([MFUtil isWorkingTime]) [self setCommentMsg];
}
...
-(void)touchedSettingButton:(UIButton *)sender{
    ...
    if ([subcriber isEqual:writer]) {
        UIAlertAction *editAction = [UIAlertAction actionWithTitle:NSLocalizedString(@"edit", @"edit")
...
//        NSLog(@"VALUE!! : %@", self.postDetailInfo);
...
- (void)commentSelect:(NSIndexPath *)indexPath{
    @try{
        ...
        if([commType isEqualToString:@"TEXT"]){
            ...
            if ([subcriber isEqual:writer]) {
                UIAlertAction *updateAction = [UIAlertAction actionWithTitle:NSLocalizedString(@"edit", @"edit")
                                                                       style:UIAlertActionStyleDefault
                                                                     handler:^(UIAlertAction * action){
