...
- (void)viewDidLoad
{
    ...
    if ((interfaceOrientation == UIDeviceOrientationLandscapeLeft)||(interfaceOrientation == UIDeviceOrientationLandscapeRight)) {
        if (bgImage==nil) {
            _imageView.image = [UIImage imageNamed:@"2021_intro_land.jpeg"];
        }else{
            _imageView.image = bgImage;
        }
        guideLabel.frame = CGRectMake(guideLabel.frame.origin.x+130, guideLabel.frame.origin.y-100,guideLabel.frame.size.width, guideLabel.frame.size.height);
        hostField.frame = CGRectMake(hostField.frame.origin.x+130, hostField.frame.origin.y-100,
                                     hostField.frame.size.width, hostField.frame.size.height);
        portField.frame = CGRectMake(portField.frame.origin.x+130, portField.frame.origin.y-100,
                                     portField.frame.size.width, portField.frame.size.height);
        button.frame = CGRectMake(button.frame.origin.x+130, button.frame.origin.y-100,
                                  button.frame.size.width, button.frame.size.height);
        infoImageView.frame = CGRectMake(infoImageView.frame.origin.x+130, infoImageView.frame.origin.y-100,
                                         infoImageView.frame.size.width, infoImageView.frame.size.height);
    }else{
        if (bgImage==nil) {
            _imageView.image = [UIImage imageNamed:@"2021_intro_port.jpeg"];
        }else{
            _imageView.image = bgImage;
        }
...
- (void)willAnimateRotationToInterfaceOrientation:(UIInterfaceOrientation)interfaceOrientation duration:(NSTimeInterval)duration{
    if ((interfaceOrientation == UIDeviceOrientationLandscapeLeft)||(interfaceOrientation == UIDeviceOrientationLandscapeRight)) {
        ...
        button.frame = CGRectMake(button.frame.origin.x-130, button.frame.origin.y+100,
                                  button.frame.size.width, button.frame.size.height);
        guideLabel.frame = CGRectMake(guideLabel.frame.origin.x-130, guideLabel.frame.origin.y+100,
                                      guideLabel.frame.size.width, guideLabel.frame.size.height);
        infoImageView.frame = CGRectMake(infoImageView.frame.origin.x-130, infoImageView.frame.origin.y+100,
                                         infoImageView.frame.size.width, infoImageView.frame.size.height);
    }
}
