...
//    UIImage *buttonImageRight = [UIImage imageNamed:@"navi_webback.png"];
    UIImage *buttonImageRight = [[UIImage imageNamed:@"navi_webback.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
    
    UIButton *rightButton = [UIButton buttonWithType: UIButtonTypeCustom];
    [rightButton setImage:buttonImageRight forState:UIControlStateNormal];
    
    [rightButton setTintColor:[appDelegate myRGBfromHex:appDelegate.naviFontColor]];
...
- (void)initUIWebView{
    ...
    NSURL *cookieURL = [NSURL URLWithString:page_url];
    NSLog(@"cookieURL.host : %@", cookieURL.host);
    
    NSUserDefaults *prefs = [NSUserDefaults standardUserDefaults];
    NSMutableDictionary *cookieProperties = [NSMutableDictionary dictionary];
    [cookieProperties setObject:@"_spi_sso_token_" forKey:NSHTTPCookieName];
    [cookieProperties setObject:[prefs objectForKey:@"STOKEN"] forKey:NSHTTPCookieValue];
    [cookieProperties setObject:@".samhwa.com" forKey:NSHTTPCookieDomain];
    [cookieProperties setObject:@"/" forKey:NSHTTPCookiePath];
    [cookieProperties setObject:@"0" forKey:NSHTTPCookieVersion];
    NSHTTPCookie *cookie = [NSHTTPCookie cookieWithProperties:cookieProperties];
    
    NSMutableDictionary *cookieProperties2 = [NSMutableDictionary dictionary];
    [cookieProperties2 setObject:@"_spi_login_ipaddr_" forKey:NSHTTPCookieName];
    [cookieProperties2 setObject:[prefs objectForKey:@"IPADDR"] forKey:NSHTTPCookieValue];
    [cookieProperties2 setObject:@".samhwa.com" forKey:NSHTTPCookieDomain];
    ...
    [[NSHTTPCookieStorage sharedHTTPCookieStorage] setCookies:[NSArray arrayWithObjects:cookie,cookie2, nil] forURL:[NSURL URLWithString:page_url] mainDocumentURL:nil];
    
//    page_url = @"https://zoom.us/j/6388021372?pwd=blhRVitmYjYwK2tIVWN5ZUY2cy94UT09";
