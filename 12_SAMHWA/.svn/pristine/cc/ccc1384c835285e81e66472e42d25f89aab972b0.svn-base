...
@interface MFinityAppDelegate : UIResponder <NSURLConnectionDataDelegate, UIApplicationDelegate, UITabBarControllerDelegate, UITabBarDelegate, UIAlertViewDelegate,AVAudioSessionDelegate,UNUserNotificationCenterDelegate, FIRMessagingDelegate, MFMailComposeViewControllerDelegate>{
    NSString *_main_url;
...
@property (strong, nonatomic) NSString *receivePushNo;
@property (strong, nonatomic) NSString *receiveDevNo;
...
@property (strong, nonatomic) NSString *app_ci;
...
@property (strong, nonatomic) NSString *subOffButtonPath;
@property (strong, nonatomic) NSString *subOnButtonPath;
