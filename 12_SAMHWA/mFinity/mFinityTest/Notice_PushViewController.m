...
- (void)viewDidLoad
{
    ...
    NSLog(@"appDelegate.subBgImagePath : %@",appDelegate.subBgImagePath);
    ...
    self.navigationItem.leftBarButtonItem.tintColor = [appDelegate myRGBfromHex:appDelegate.naviFontColor];
    //self.navigationController.navigationBar.barTintColor = [appDelegate myRGBfromHex:appDelegate.naviFontColor];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.contentLbl.textColor = [appDelegate myRGBfromHex:appDelegate.subFontColor];
    cell.contentLbl.backgroundColor = [UIColor clearColor];
    int fontSize = 16;
    int fontSize2 = 11;
    ...
    switch ([prefs integerForKey:@"FONT_SIZE"]) {
        case 1:
            ...
            [cell.dateLbl setFrame:CGRectMake(mainWidth-75, 0, 70, 50)];
            break;
        case 2:
            fontSize = fontSize+10;
            fontSize2 = fontSize2+5;
            cell.dateLbl.numberOfLines = 4;
            [cell.dateLbl setFrame:CGRectMake(mainWidth-85, 0, 70, 70)];
            break;
        default:
            break;
    }
    cell.contentLbl.font = [UIFont systemFontOfSize:fontSize];
    cell.dateLbl.font = [UIFont systemFontOfSize:fontSize2];
    cell.dateLbl.textColor = [appDelegate myRGBfromHex:appDelegate.subFontColor];
    
    cell.dateLbl.backgroundColor = [UIColor clearColor];
    cell.dateLbl.alpha = 0.6;
    
    UIImageView *image = nil;
    if (noticeViewFlag) {
        image = [[UIImageView alloc] initWithFrame:CGRectMake(223, 15, 20, 20)];
        ...
        cell.contentLbl.text = titleString;
    ...
    NSString *titleString;
    UILabel *dateLabel = [[UILabel alloc] initWithFrame:CGRectMake(250, 0, 70, 50)];
    ...
    switch ([prefs integerForKey:@"FONT_SIZE"]) {
        ...
        case 2:
            ...
            [dateLabel setFrame:CGRectMake(250, 0, 70, 70)];
            break;
        default:
            break;
    }
    titleLabel.font = [UIFont systemFontOfSize:fontSize];
    dateLabel.font = [UIFont systemFontOfSize:fontSize2];
