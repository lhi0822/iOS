...
- (void)viewDidLoad {
    ...
    if ((toInterfaceOrientation == UIDeviceOrientationLandscapeLeft)||(toInterfaceOrientation == UIDeviceOrientationLandscapeRight)) {
        ...
        if (bgImage==nil) {
            imageView.image = [UIImage imageNamed:@"2021_intro_land.jpeg"];
        }else{
        ...
        btnLogin.frame = CGRectMake(btnLogin.frame.origin.x, btnLogin.frame.origin.y, btnLogin.frame.size.width, btnLogin.frame.size.height);
        ...
        txtID.frame = CGRectMake(txtID.frame.origin.x, txtID.frame.origin.y, txtID.frame.size.width, txtID.frame.size.height);
        txtPWD.frame = CGRectMake(txtPWD.frame.origin.x, txtPWD.frame.origin.y, txtPWD.frame.size.width, txtPWD.frame.size.height);
        label3.frame = CGRectMake(label3.frame.origin.x, label3.frame.origin.y, label3.frame.size.width, label3.frame.size.height);
        label4.frame = CGRectMake(label4.frame.origin.x, label4.frame.origin.y+100, label4.frame.size.width, label4.frame.size.height);
        ...
        saveID.frame = CGRectMake(saveID.frame.origin.x, saveID.frame.origin.y, saveID.frame.size.width, saveID.frame.size.height);
...
//                [appDelegate loginErrorToLogFile:@"isOffline" :e];
            }
...
//                [appDelegate loginErrorToLogFile:@"Login" :e];
            }
...
//                    [appDelegate loginErrorToLogFile:@"ezLoginSHP-FCM" :e];
                }
...
//            [appDelegate loginErrorToLogFile:@"ezLoginSHP" :e];
        }
