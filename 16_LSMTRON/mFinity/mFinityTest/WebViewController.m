...
//    if(jsCommand.length>30000){
//        UIAlertView *alertView = [[UIAlertView alloc]initWithTitle:@"" message:NSLocalizedString(@"iOS 콜백 반환 최대 길이는 30,000byte까지 가능합니다.", @"iOS 콜백 반환 최대 길이는 30,000byte까지 가능합니다.") delegate:self cancelButtonTitle:NSLocalizedString(@"message51", @"확인") otherButtonTitles: nil];
//        [alertView show];
//
//    } else {
        //[mywebView stringByEvaluatingJavaScriptFromString:jsCommand];
