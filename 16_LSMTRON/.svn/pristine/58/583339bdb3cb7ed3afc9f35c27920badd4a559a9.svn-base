...
- (NSString *)modelNameForModelIdentifier:(NSString *)modelIdentifier
{
    ...
    if ([modelIdentifier isEqualToString:@"iPad6,3"])      return @"iPad Pro 9.7-inch (Wi-Fi)";
    if ([modelIdentifier isEqualToString:@"iPad6,4"])      return @"iPad Pro 9.7-inch (Cellular)";
    if ([modelIdentifier isEqualToString:@"iPad6,7"])      return @"iPad Pro 12.9-inch (Wi-Fi)";
    if ([modelIdentifier isEqualToString:@"iPad6,8"])      return @"iPad Pro 12.9-inch (Cellular)";
    ...
    if ([modelIdentifier isEqualToString:@"iPad7,1"])      return @"iPad Pro 12.9-inch 2nd (Wi-Fi)";
    if ([modelIdentifier isEqualToString:@"iPad7,2"])      return @"iPad Pro 12.9-inch 2nd (Cellular)";
    if ([modelIdentifier isEqualToString:@"iPad7,3"])      return @"iPad Pro 10.5-inch 2nd (Wi-Fi)";
    if ([modelIdentifier isEqualToString:@"iPad7,4"])      return @"iPad Pro 10.5-inch 2nd (Cellular)";
