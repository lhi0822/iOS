...
- (void)viewDidLoad
{
    ...
    //UIBarButtonItem *back = [[UIBarButtonItem alloc]initWithTitle:NSLocalizedString(@"Back", @"") style:UIBarButtonItemStyleBordered target:self action:@selector(goBackAdd:)];
...
- (void)leftButtonClick{
    ...
    if (noticeViewFlag) {
        ...
        self.navigationItem.titleView = label;
        self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:appDelegate.noticeTitle style:UIBarButtonItemStyleBordered target:self action:@selector(leftButtonClick)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UILabel *dateLabel = [[UILabel alloc] initWithFrame:CGRectMake(mainWidth-65, 0, 70, 50)];
    ...
    switch ([prefs integerForKey:@"FONT_SIZE"]) {
        case 1:
            ...
            [dateLabel setFrame:CGRectMake(mainWidth-75, 0, 70, 50)];
            break;
        case 2:
            ...
            [dateLabel setFrame:CGRectMake(mainWidth-85, 0, 70, 70)];
            break;
        default:
            break;
    }
