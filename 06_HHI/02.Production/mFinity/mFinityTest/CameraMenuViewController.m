...
- (void)viewDidLoad
{
	...
	//[pictureIcon setBackgroundImage:[UIImage imageNamed:@"camera_over_01"] forState:UIControlStateSelected];
	pictureIcon.tag = 1;
	[pictureIcon setFrame:CGRectMake(65, 30, 198, 131)];
	...
	listIcon.tag = 2;
	[listIcon setFrame:CGRectMake(65, 181, 198, 131)];
...
//        WKWebViewController *webView = [[self.navigationController viewControllers]objectAtIndex:[arr count]-2];
