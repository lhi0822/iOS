...
@interface WKWebViewController : UIViewController <WKNavigationDelegate, WKUIDelegate, WKScriptMessageHandler, UIPopoverControllerDelegate, UIScrollViewDelegate,UIApplicationDelegate,UIActionSheetDelegate,CLLocationManagerDelegate,UIAlertViewDelegate,MFBarcodeScannerDelegate,MFMessageComposeViewControllerDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,DownloadListDelegate,UploadListDelegate, NSURLConnectionDelegate, NSURLConnectionDataDelegate, NSURLSessionDelegate, NSURLSessionDataDelegate, NSURLSessionTaskDelegate> {
