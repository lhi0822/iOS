...
//    NSDictionary *test = [[NSDictionary alloc] initWithObjectsAndKeys:@"1609",@"V1", @"A0",@"V10", @"#",@"V11", @"#",@"V12", @"#",@"V13", @"#",@"V14", @"Y",@"V15", @"N",@"V16", @"N",@"V17", @"-1",@"V18", @"1",@"V2", @"729",@"V3", @"태풍상황모니터링",@"V4", @"https://touch1.hhi.co.kr/mfinity/upload/icon/10/1/10_1_1599182613383.png",@"V5", @"https://hi-conet.hhi.co.kr/Services47/CPP009.Web/TypnIssue/Index",@"V6", @"#",@"V6_1", @"P",@"V7", @"4",@"V8", @"5",@"V8_1", @"[태풍] 태풍상황모니터링",@"V9", nil];
    for (NSDictionary *menuDic in tempArr) {
        [menuArray addObject: [MFinityAppDelegate getAllValueUrlDecoding:menuDic]];
//        [menuArray addObject:test];
    }
...
-(void) buttonToIndex:(int)indexBtn {
    ...
    NSLog(@"%s", __func__);
    NSLog(@"[menuArray objectAtIndex:indexBtn] : %@", [menuArray objectAtIndex:indexBtn]);
...
//            appDelegate.target_url = @"hhi.mobile.ios.sns";
...
-(void) addMenuHist:(NSString *)menu_no {
    if (!appDelegate.isOffLine) {
        if ([appDelegate.demo isEqualToString:@"DEMO"]) {
            ...
            NSLog(@"addMenuHist paramStr : %@", paramStr);
