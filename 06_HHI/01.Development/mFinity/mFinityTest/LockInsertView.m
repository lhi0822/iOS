...
- (IBAction) okButton {
    ...
    NSUserDefaults *prefs = [NSUserDefaults standardUserDefaults];
    if (appDelegate.isAES256) {
//        param = [[NSString alloc]initWithFormat:@"DEV_ID=%@&DEV_OS=%@&DEMO_FLAG=%@&CUSER_NO=%@&userId=%@&passwd=%@&COMP_NO=%@&PUSH_ID1=%@&PUSH_ID2=-&encType=AES256",[prefs objectForKey:@"UUID"],osName,appDelegate.noAuth,appDelegate.user_no,encodingID,encodingPWD,appDelegate.comp_no,appDelegate.appDeviceToken];
        param = [[NSString alloc]initWithFormat:@"DEV_ID=%@&DEV_OS=%@&DEMO_FLAG=%@&CUSER_NO=%@&userId=%@&passwd=%@&COMP_NO=%@&PUSH_ID1=%@&PUSH_ID2=-&encType=AES256",[prefs objectForKey:@"UUID"],osName,appDelegate.noAuth,appDelegate.user_no,encodingID,encodingPWD,appDelegate.comp_no,appDelegate.fcmToken];
        
    }else{
//        param = [[NSString alloc]initWithFormat:@"DEV_ID=%@&DEV_OS=%@&DEMO_FLAG=%@&CUSER_NO=%@&userId=%@&passwd=%@&COMP_NO=%@&PUSH_ID1=%@&PUSH_ID2=-",[prefs objectForKey:@"UUID"],osName,appDelegate.noAuth,appDelegate.user_no,encodingID,encodingPWD,appDelegate.comp_no,appDelegate.appDeviceToken];
        param = [[NSString alloc]initWithFormat:@"DEV_ID=%@&DEV_OS=%@&DEMO_FLAG=%@&CUSER_NO=%@&userId=%@&passwd=%@&COMP_NO=%@&PUSH_ID1=%@&PUSH_ID2=-",[prefs objectForKey:@"UUID"],osName,appDelegate.noAuth,appDelegate.user_no,encodingID,encodingPWD,appDelegate.comp_no,appDelegate.fcmToken];
    }
