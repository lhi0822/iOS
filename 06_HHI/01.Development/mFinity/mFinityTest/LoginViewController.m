...
#ifdef DEBUG
//    txtID.text = @"a383333";
//    txtPWD.text = @"13125671SNSD";
    
//    txtID.text = @"bp15214";
//    txtPWD.text = @"feel100101";
#endif
...
- (IBAction)initPwdButton:(id)sender {
    ...
    appDelegate.target_url = [[NSString alloc] initWithFormat:@"http://dev.hhi.co.kr:49175/dataservice41/PwdUpdate.jsp"];
...
//    }
    if ([alertView.title isEqualToString:NSLocalizedString(@"message54", @"")]) {
        if (buttonIndex==0) {
//            deployURL = @"itms-services://?action=download-manifest&url=https://dev.hhi.co.kr:44175/mfinity/upload/deploy/10/1/TouchOne_dev_5.2.4-001.plist";
