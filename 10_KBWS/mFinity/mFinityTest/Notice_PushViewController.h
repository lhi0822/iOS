...
@interface Notice_PushViewController : UIViewController<UITableViewDataSource,NSURLConnectionDataDelegate, UITableViewDelegate, UIScrollViewDelegate,UIAlertViewDelegate,MFBarcodeScannerDelegate,DownloadListDelegate, UIGestureRecognizerDelegate>{
