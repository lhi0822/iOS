...
+ (DeviceSize)deviceSize
{
    ...
    NSLog(@"## deviceSize : %ld", (long)deviceSize);
...
//hilee custom
+ (DeviceSize)customResolutionSize
{
    CGFloat screenHeight = 0;
...
+ (DeviceSize)customDeviceSize
{
    DeviceSize deviceSize = [self customResolutionSize];
...
+ (float)customDeviceSizeWidth:(DeviceSize)deviceSize
{
    float width = 0;
    if (deviceSize == UnknownSize) {
        width = 0;
    } else if (deviceSize == Screen3Dot5inch) {
        width = 320;
    } else if (deviceSize == Screen4inch) {
        width = 320;
    } else if (deviceSize == Screen4Dot7inch) {
        width = 375;
    } else if (deviceSize == Screen5Dot5inch) {
        width = 414;
    } else if (deviceSize == Screen5Dot8inch) {
        width = 375;
    } else if (deviceSize == Screen6Dot5inch) {
        width = 414;
    }
