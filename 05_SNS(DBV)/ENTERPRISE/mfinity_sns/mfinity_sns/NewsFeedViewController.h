...
#import "ProjectFeedViewCell.h"
#import "TTTAttributedLabel.h"


@interface NewsFeedViewController : UIViewController <UITableViewDelegate,UITableViewDataSource,MFURLSessionDelegate,UIScrollViewDelegate,UITextFieldDelegate, floatMenuDelegate, UITableViewDataSourcePrefetching, NSURLSessionDelegate, TTTAttributedLabelDelegate, SDWebImageManagerDelegate> {
    BOOL isRefresh;
    BOOL isDragging;
