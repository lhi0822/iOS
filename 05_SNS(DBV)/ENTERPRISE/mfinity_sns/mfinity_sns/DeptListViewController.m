...
- (void)callWebService{
    ...
    if([self.fromSegue isEqualToString:@"CHAT_SIDE_ADD_USER_PUSH"] || [self.fromSegue isEqualToString:@"CHAT_SIDE_NEW_ROOM_PUSH"]){
        NSString *paramString = [NSString stringWithFormat:@"compNo=%@&deptNo=%@&retVal=""&currentUserNos=%@&dvcId=%@", compNo, self.deptNo, jsonData, [appDelegate.appPrefs objectForKey:@"DVC_ID"]];
