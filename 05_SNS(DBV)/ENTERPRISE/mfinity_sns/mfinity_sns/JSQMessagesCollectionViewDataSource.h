...
- (nullable NSAttributedString *)collectionView:(JSQMessagesCollectionView *)collectionView attributedTextForMessageDateLabelAtIndexPath:(NSIndexPath *)indexPath;

- (nullable NSAttributedString *)collectionView:(JSQMessagesCollectionView *)collectionView attributedTextForSystemLabelAtIndexPath:(NSIndexPath *)indexPath;
