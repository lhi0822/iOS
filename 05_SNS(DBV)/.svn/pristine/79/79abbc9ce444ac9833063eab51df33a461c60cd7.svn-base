...
@property (weak, nonatomic) IBOutlet JSQMessagesLabel *messageDate;
@property (weak, nonatomic) IBOutlet JSQMessagesLabel *systemLabel;
...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *messageDateConstraint;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *systemLabelConstraint;
...
- (void)awakeFromNib
{
    ...
    UIFont *systemLabelFont = [UIFont preferredFontForTextStyle:UIFontTextStyleCaption1];
    self.systemLabel.textAlignment = NSTextAlignmentCenter;
    self.systemLabel.font = topLabelFont;
    self.systemLabel.textColor = [UIColor lightGrayColor];
    ...
    self.systemLabelConstraint.constant = systemLabelFont.pointSize;
...
- (void)applyLayoutAttributes:(UICollectionViewLayoutAttributes *)layoutAttributes
{
    ...
    [self jsq_updateConstraint:self.messageDateConstraint
                  withConstant:customAttributes.cellMessageDateHeight];
    
    [self jsq_updateConstraint:self.systemLabelConstraint
                  withConstant:customAttributes.cellSystemLabelHeight];
...
- (void)setAvatarViewSize:(CGSize)avatarViewSize
{
    ...
    //NSLog(@"avatar size : %f, %f", avatarViewSize.width, avatarViewSize.height);
