...
- (void)viewWillAppear:(BOOL)animated{
    ...
    if([[[MFSingleton sharedInstance] legacyName] isEqualToString:@"ANYMATE"]){
        [appDelegate.appPrefs setObject:@"5" forKey:[appDelegate setPreferencesKey:@"LASTTABITEM"]];
...
//            if([AccessAuthCheck photoAccessCheckNotAuth]){
...
- (void)callWebService{
    ...
    NSString *paramString = [NSString stringWithFormat:@"usrNo=%@&refTy=%@&compNo=%@&dvcId=%@", userNo, refTy, compNo,  [appDelegate.appPrefs objectForKey:@"DVC_ID"]];
