...
- (void)callGetPostList{
    ...
    NSString *paramString = [NSString stringWithFormat:@"usrNo=%@&compNo=%@&refTy=1&stPostSeq=%@&target_usrNo=%@&dvcId=%@", myUserNo, compNo, self.lastPostNo, self.userNo, [appDelegate.appPrefs objectForKey:@"DVC_ID"]];
