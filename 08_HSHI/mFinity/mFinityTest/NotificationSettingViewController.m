...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if([indexPath section]==0)
	{
        ...
        //UISwitch *updateSwitch = [[UISwitch alloc]initWithFrame:CGRectMake(250, 9, 50, 50)];
        UISwitch *updateSwitch = [[UISwitch alloc] initWithFrame:CGRectMake(mainWidth-65, 9, 50, 50)];
