...
- (void)viewDidLoad {
    ...
    NSString *str1 = @"스마트원 관련 MDM 기능에 대한 고지 및\n개인정보 수집/이용 동의 안내";
    ...
    NSString *str2_1 = @"안녕하세요? \n원활한 스마트원 서비스 제공과 관련하여 모바일단말관리 (MDM) 기능을 통해 사용자 ";
    ...
    NSString *str2_7 = @"을 설명하고 개인정보 수집 및 이용에 대한 동의를 구하고자 합니다. 개인정보 수집/이용을 원하지 않으실 경우 동의하지 않을 수 있으며, 미동의 시에는 스마트원 서비스 이용이 불가함을 알려드립니다.";
...
//    boxTxtView.layer.borderColor = [UIColor blackColor].CGColor;
    ...
    NSString *str7 = @"회사는 스마트원을 이용한 회사 자료 유출 등 스마트원 사용 중에 발생할 수 있는 보안사고를 미연에 방지하기 위하여 스마트원 서비스 접속 시간 동안 모바일 단말 관리 기능을 통해 사용자 단말기의 화면 캡쳐 기능을 제한ㆍ통제 하고자 합니다. \n";
    ...
    NSString *str8 = @"3. 회사는 추후 스마트원에 적용되는 모바일 단말 관리 통제 기능이 추가·변경될 경우, 이를 즉시 임직원에게 고지하겠습니다. \n";
    ...
    NSString *str9 = @"4. 임직원은 본 동의서에 의한 모바일 단말 관리 통제 기능에 대한 동의를 거부하실 권리가 있습니다. 단, 동의를 거부하는 경우에는 스마트원 사용이 불가함을 알려드립니다.";
    ...
    NSString *str12 = @"회사는 임직원의 스마트원 서비스 제공을 위한 목적으로 임직원의 개인정보를 수집 및 이용하고자 하며, 본 동의서의 범위를 초과하는 수집 및 이용이 필요한 경우에는 별도의 동의를 받겠습니다. \n";
    ...
    NSString *str14_2 = @"스마트원 관련 수집 항목 \n- 설치 단말기 정보, 사용자정보 \n- 로그인 정보, 업무앱 실행시간";
    ...
    NSString *str17 = @"8. 임직원은 본 동의서에 의한 개인정보의 수집 및 이용에 대한 동의를 거부하실 권리가 있습니다. 단, 동의를 거부하는 경우에는 스마트원 사용이 불가함을 알려드립니다.";
