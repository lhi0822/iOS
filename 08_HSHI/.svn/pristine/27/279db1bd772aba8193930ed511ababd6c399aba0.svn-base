...
-(void)actionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex{
	if (buttonIndex==0) {
		...
		if ([rowsToBeDeleted count]==0) {
            ...
            self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"message72", @"") style:UIBarButtonItemStylePlain target:self action:@selector(rightBtnClick)];
...
-(void) rightBtnClick{
	...
	if (!inPseudoEditMode) {
        ...
        */
        self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"message52", @"") style:UIBarButtonItemStylePlain target:self action:@selector(rightBtnClick)];
        
        self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"message84", @"") style:UIBarButtonItemStylePlain target:self action:@selector(leftBtnClick)];
