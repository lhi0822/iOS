...
-(void)viewWillAppear:(BOOL)animated{
    ...
    if(noticeViewFlag){
        ...
        self.hideView1.backgroundColor = [appDelegate myRGBfromHex:@"4C6F9F"]; //[UIColor whiteColor];
        ...
        self.hideView2.backgroundColor = [appDelegate myRGBfromHex:@"4C6F9F"]; //[UIColor whiteColor];
...
- (void)viewDidLoad {
    ...
    [appDelegate loginHistoryToLogFile:[NSString stringWithFormat:@"%s //Notice탭",__func__] result:nil];
...
//        [self.pushBtn setTitleColor:[UIColor lightGrayColor] forState:UIControlStateNormal];
        [self.noticeBtn setTitleColor:[appDelegate myRGBfromHex:appDelegate.mainFontColor] forState:UIControlStateNormal];
        [self.pushBtn setTitleColor:[appDelegate myRGBfromHex:appDelegate.mainFontColor :0.66f] forState:UIControlStateNormal];
        [self noticeAction:self.noticeBtn];
    } else {
//        [self.noticeBtn setTitleColor:[appDelegate myRGBfromHex:appDelegate.naviBarColor] forState:UIControlStateNormal];
//        [self.pushBtn setTitleColor:[UIColor lightGrayColor] forState:UIControlStateNormal];
        [self.noticeBtn setTitleColor:[appDelegate myRGBfromHex:appDelegate.mainFontColor :0.66f] forState:UIControlStateNormal];
        [self.pushBtn setTitleColor:[appDelegate myRGBfromHex:appDelegate.mainFontColor] forState:UIControlStateNormal];
        [self noticeAction:self.noticeBtn];
    ...
    _tableView.separatorColor = [appDelegate myRGBfromHex:appDelegate.mainFontColor];
...
-(void) viewDidAppear:(BOOL)animated{
    ...
    if (appDelegate.receivePush) {
        ...
        if (appDelegate.isOffLine) {
            ...
            appDelegate.menu_title = appDelegate.noticeTitle;
