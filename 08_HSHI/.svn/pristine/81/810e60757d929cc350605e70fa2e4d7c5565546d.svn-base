...
@interface MFinityAppDelegate : UIResponder <NSURLConnectionDataDelegate, UIApplicationDelegate, UITabBarControllerDelegate, UITabBarDelegate, UIAlertViewDelegate,AVAudioSessionDelegate,UNUserNotificationCenterDelegate, UIScrollViewDelegate, FIRMessagingDelegate>{
    NSString *_main_url;
...
@property (strong, nonatomic) NSString *mdmFlag;

@property (assign, nonatomic) BOOL isInitPwd;
@property (assign, nonatomic) BOOL isSettingPwd;
...
@property (assign, nonatomic) BOOL isMDM;
