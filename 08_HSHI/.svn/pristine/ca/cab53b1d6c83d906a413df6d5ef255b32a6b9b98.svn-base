...
- (void)viewDidLoad
{
    ...
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"message52", @"취소") style:UIBarButtonItemStylePlain target:self action:@selector(cancelButtonClick)];
...
- (void)errorDownload{
    ...
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"message166", @"닫기") style:UIBarButtonItemStylePlain target:self action:@selector(errorButtonClick)];
}
- (void)endDownload{
    _tableView.scrollEnabled = YES;
    
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"message166", @"닫기") style:UIBarButtonItemStylePlain target:self action:@selector(leftButtonClick)];
}
...
-(void)connection:(NSURLConnection *)connection didReceiveResponse:(NSURLResponse *)response{
    ...
    if(statusCode == 404 || statusCode == 500){
        ...
        self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"Refresh" style:UIBarButtonItemStylePlain target:self action:@selector(rightButtonClick)];
        [self errorDownload];
        UIAlertView *alertView = [[UIAlertView alloc]initWithTitle:@"Error" message:[NSString stringWithFormat:@"%d Error %ld %@",statusCode,NSLocalizedString(@"message12", @"")] delegate:self cancelButtonTitle:NSLocalizedString(@"message51", @"") otherButtonTitles: nil];
        [alertView show];
