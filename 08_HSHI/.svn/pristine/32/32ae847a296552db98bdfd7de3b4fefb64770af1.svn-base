...
- (void)endUpload{
    ...
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"닫기" style:UIBarButtonItemStylePlain target:self action:@selector(leftButtonClick)];
}
...
-(void)connection:(NSURLConnection *)connection didReceiveData:(NSData *)data{
    ...
    if (error==nil) {
        ...
        NSLog(@"_uploadFilePathArray.count : %lu, progressTag : %d", (unsigned long)_uploadFilePathArray.count, progressTag);
