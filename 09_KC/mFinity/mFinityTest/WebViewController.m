...
- (void)webView:(WKWebView *)webView didStartProvisionalNavigation:(WKNavigation *)navigation{
    ...
    if([[url scheme]isEqualToString:@"mfinity"]){
...
//                NSString *ext = [[lastPath substringFromIndex:range.location+1] lowercaseString];
//                NSLog(@"fileExt : %@", ext);
//
//                if([ext isEqualToString:@"xdw"]||[ext isEqualToString:@"zip"]){
//                    return NO;
//
//
//                }
    ...
    if (_backMode) {
        ...
        if (IS_OS_8_OR_LATER) {
            ...
            if ([mywebView canGoBack]) {
                NSLog(@"webviewurl : %@", mywebView.request.URL.absoluteString);
                NSString *pageUrl = mywebView.request.URL.absoluteString;
                if([pageUrl isEqualToString:@"https://kmes.kc.co.kr:8080/main.aspx"]){
                    //PDA
                    [self.navigationController popToRootViewControllerAnimated:YES];
                    
                } else if([pageUrl isEqualToString:@"https://nmes.kc.co.kr:8081/main.aspx"]){
                    //PDA
                    [self.navigationController popToRootViewControllerAnimated:YES];
                    
                } else if([pageUrl isEqualToString:@"https://mtong.kc.co.kr/gw/webmain.nsf/MLogOn?OpenForm"]){
                    //Tong
                    [self.navigationController popToRootViewControllerAnimated:YES];
                    
                } else if([pageUrl isEqualToString:@"https://hr.kc.co.kr/Main.do"]||[pageUrl isEqualToString:@"https://hr.kc.co.kr/Main.do#"]){
                    //HR
                    [self.navigationController popToRootViewControllerAnimated:YES];
                
                } else if([pageUrl isEqualToString:@"http://nmesqa.kc.co.kr:8080/main.aspx"]){
                    //PDA_QA
                    [self.navigationController popToRootViewControllerAnimated:YES];
