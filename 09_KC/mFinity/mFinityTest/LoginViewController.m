...
-(void)connectionDidFinishLoading:(NSURLConnection *)connection{
    ...
    if ([methodName isEqualToString:@"getOfflineMenuList"]) {
        ...
        if ([result isEqualToString:@"SUCCEED"]) {
            ...
            NSLog(@"response.URL : %@",urlStr);
            NSHTTPURLResponse *response = (NSHTTPURLResponse *)response;
            NSArray *cookies =[NSHTTPCookie cookiesWithResponseHeaderFields:[response allHeaderFields] forURL:connection.currentRequest.URL];
