...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UILabel *dateLabel = [[UILabel alloc] initWithFrame:CGRectMake(cell.frame.size.width-15, 0, 70, 50)];
    ...
    switch ([prefs integerForKey:@"FONT_SIZE"]) {
        ...
        case 2:
            ...
            [dateLabel setFrame:CGRectMake(cell.frame.size.width-20, 0, 70, 70)];
            break;
        default:
            break;
    }
