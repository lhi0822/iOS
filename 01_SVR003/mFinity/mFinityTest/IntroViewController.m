...
- (void)viewDidLoad
{
	...
	if (bgImage == nil) {
		bgImage = [UIImage imageNamed:@"default_intro.png"];
	}
    ...
    if([prefs objectForKey:@"URL_ADDRESS"]==nil){
        NSString *mainURL = @"http://obm.mfrontiers.com:1598/dataservice41";
        //NSString *mainURL = @"http://emmp.mfrontiers.com:8001/dataservice41";
