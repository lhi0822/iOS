...
- (void)viewDidLoad
{
    ...
    if (appDelegate.isOffLine) {
        menuArray = [[NSMutableArray alloc]initWithObjects:
                     NSLocalizedString(@"message26", @"시스템 정보"),
                     NSLocalizedString(@"message29", @"잠금 설정"), nil];
        
        tmpIconArray = [[NSArray alloc]initWithObjects:
                     @"set_systeminfo.png",
                     @"set_lock.png",nil];
    }else{
        if ([appDelegate.noAuth isEqualToString:@"DEMO"]) {
            menuArray = [[NSMutableArray alloc]initWithObjects:
                         NSLocalizedString(@"message26", @"시스템 정보"),
                         NSLocalizedString(@"message37", @"시작페이지 설정"),
                         NSLocalizedString(@"message154", @"폰트 설정"),
                         NSLocalizedString(@"message32", @"알림 설정"),
                         NSLocalizedString(@"message29", @"잠금 설정"),
                         NSLocalizedString(@"message38", @"컨텐츠 삭제"),
                         NSLocalizedString(@"message111", @"Off-Line 웹앱 다운로드"),nil];
            ...
            if ([[prefs objectForKey:@"OFFLINE_FLAG"] isEqualToString:@"N"]) {
                menuArray = [[NSMutableArray alloc]initWithObjects:
                             NSLocalizedString(@"message26", @"시스템 정보"),
                             NSLocalizedString(@"message37", @"시작페이지 설정"),
                             NSLocalizedString(@"message43", @"마이메뉴 설정"),
                             NSLocalizedString(@"message154", @"폰트 설정"),
                             NSLocalizedString(@"message32", @"알림 설정"),
                             NSLocalizedString(@"message29", @"잠금 설정"),
                             NSLocalizedString(@"message38", @"컨텐츠 삭제"),
                             NSLocalizedString(@"message44", @"비밀번호 변경"), nil];
                ...
                menuArray = [[NSMutableArray alloc]initWithObjects:
                             ...
                             NSLocalizedString(@"message29", @"잠금 설정"),
                             NSLocalizedString(@"message38", @"컨텐츠 삭제"),
                             NSLocalizedString(@"message44", @"비밀번호 변경"),
                             NSLocalizedString(@"message110", @"Off-Line 비밀번호 변경"),
                             NSLocalizedString(@"message111", @"Off-Line 웹앱 다운로드"),nil];
