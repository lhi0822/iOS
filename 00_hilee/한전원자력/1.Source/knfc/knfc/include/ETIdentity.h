 ...
 *
 * @param time the time for the OTP
 *
 * @return OTP for this identity for the specified time.
 */
 ...
 *
 * @return a transaction confirmation code.
 *
 */
 ...
 *
 * @param unlockChallenge the unlock challenge
 *
 * @param unlockCode the unlock response provided by IdentityGuard.
 *
 * @return YES if the response is valid for this identity and challenge.
 *            Return NO otherwise.
 */
 ...
 * @param urlParams The offline transaction URL parameters
 * @param identity The identity to use to decrypt the transaction details.
 * @return The transaction if it could be decrypted or nil.
 */
