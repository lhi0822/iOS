...
+ (void)setTargetActionBySender:(id)sender target:(id)target action:(SEL)action;
+ (NSString *)getIpadXIB:(NSString *)xibName;
+ (UIView *)loadViewFromXIB:(NSString *)xibName owner:(id)owner;
