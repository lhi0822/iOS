    ...
    if (UIWebViewNavigationTypeLinkClicked == navigationType || UIWebViewNavigationTypeOther == navigationType) {
        ...
        if ([[[request URL] scheme]isEqualToString:@"ezmovetab"]) {
            ...
            if ([host isEqualToString:@"camera"]) {
                ...
                NSString *jsCommand = [NSString stringWithFormat:@"CBAddressBook('%@');",dic];
                ...
                //photo 폴더 경로 넘겨주면 됨
                NSString *jsCommand = [NSString stringWithFormat:@"CBFilePath('%@','%@');",[self getPhotoFilePath],[self getPhotoFilePath]];
                [mywebView stringByEvaluatingJavaScriptFromString:jsCommand];
...
- (void)signSave:(NSString *)fileName :(NSString *)userSpecific :(NSString *)callbackFunc{
    ...
    NSString *jsCommand = [NSString stringWithFormat:@"%@('%@','%@');",callbackFunc,userSpecific,fileName];
    NSLog(@"jsCommand : %@",jsCommand);
    [mywebView stringByEvaluatingJavaScriptFromString:jsCommand];
}
- (void)signSave:(NSString *)fileName{
    ...
    NSString *jsCommand = [NSString stringWithFormat:@"CBSignPad('%@','%@');",fileName,[fileName lastPathComponent]];
    [mywebView stringByEvaluatingJavaScriptFromString:jsCommand];
}
- (void)photoSave:(NSString *)fileName{
    ...
    NSString *jsCommand = [NSString stringWithFormat:@"photoSave('%@','%@');",fileName,[fileName lastPathComponent]];
    [mywebView stringByEvaluatingJavaScriptFromString:jsCommand];
}
- (void)photoSave:(NSString *)fileName :(NSString *)userSpectific :(NSString *)callbackFunc{
    ...
    NSString *jsCommand = [NSString stringWithFormat:@"%@('%@','%@');",callbackFunc,userSpectific,fileName];
    [mywebView stringByEvaluatingJavaScriptFromString:jsCommand];
}
//이게 호출됨
...
-(void)executePush:(NSString *)callBackFunc :(NSString *)userSpecific :(NSString *)userList :(NSString *)message{
    ...
    NSData *_paramData = [_paramString dataUsingEncoding:NSUTF8StringEncoding allowLossyConversion:YES];
    _callBackDic = [[NSMutableDictionary alloc]init];
    [_callBackDic setValue:[callBackFunc urlEncodeUsingEncoding:NSUTF8StringEncoding] forKey:@"callBackFunc"];
    [_callBackDic setValue:[userSpecific urlEncodeUsingEncoding:NSUTF8StringEncoding] forKey:@"userSpecific"];
    ...
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc]initWithURL:url];
    [request setHTTPMethod:@"POST"];
    [request setHTTPBody: _paramData];
    [request setTimeoutInterval:10.0];
...
-(void)executeRetrieve:(NSString *)dbName :(NSString *)selectStmt :(NSString *)callBackFunc :(NSString *)userSpecific{
    ...
    NSString *jsCommand = [NSString stringWithFormat:@"%@('%@', '%@');",callBackFunc,userSpecific,returnStr];
...
-(void)stopAccelerometer{
    ...
    NSString *jsCommand = [NSString stringWithFormat:@"%@('%@','%@','%@','%@');",_callbackFunc,_userSpecific,[accelorInfo objectAtIndex:1],[accelorInfo objectAtIndex:2],[accelorInfo objectAtIndex:3]];
...
-(void)stopGyroscope{
    ...
    NSString *jsCommand = [NSString stringWithFormat:@"%@('%@','%@','%@','%@');",_callbackFunc,_userSpecific,[accelorInfo objectAtIndex:0],[accelorInfo objectAtIndex:1],[accelorInfo objectAtIndex:2]];
...
-(void)stopMagneticField{
    ...
    NSString *jsCommand = [NSString stringWithFormat:@"%@('%@','%@','%@','%@');",_callbackFunc,_userSpecific,[sensorInfo objectAtIndex:0],[sensorInfo objectAtIndex:1],[sensorInfo objectAtIndex:2]];
...
-(void)getGpsLocation:(NSString *)callBackFunc :(NSString *)userSpecific {
    ...
    NSString *jsCommand;
    if (userSpecific == nil) {
        jsCommand = [NSString stringWithFormat:@"%@('%f', '%f');",callBackFunc,locationManager.location.coordinate.latitude,locationManager.location.coordinate.longitude];
    }else{
        jsCommand = [NSString stringWithFormat:@"%@('%@','%f', '%f');",callBackFunc,userSpecific,locationManager.location.coordinate.latitude,locationManager.location.coordinate.longitude];
    }
...
-(void)getDeviceSpec:(NSString *)callBackFunc :(NSString *)userSpecific :(NSString *)specName{
    ...
    NSString *jsCommand = [NSString stringWithFormat:@"%@('%@','%@');",callBackFunc,userSpecific,[deviceSpec objectForKey:specName]];
    [mywebView stringByEvaluatingJavaScriptFromString:jsCommand];
}
-(void)getDeviceSpec:(NSString *)callBackFunc :(NSString *)userSpecific{
    ...
    NSString *jsCommand = [NSString stringWithFormat:@"%@('%@','%@');",callBackFunc,userSpecific,[spec urlEncodeUsingEncoding:NSUTF8StringEncoding]];
...
- (void)isRoaming:(NSString *)callBackFunc :(NSString *)userSpecific{
    NSString *jsCommand;
    if ([self isRoaming]) {
        jsCommand= [NSString stringWithFormat:@"%@('%@','YES');",callBackFunc,userSpecific];
    }else{
        jsCommand= [NSString stringWithFormat:@"%@('%@','NO');",callBackFunc,userSpecific];
    }
...
-(void)getFilePath:(NSString *)callBackFunc :(NSString *)userSpecific {
    NSString *jsCommand = [NSString stringWithFormat:@"%@('%@','%@','%@');",callBackFunc,userSpecific,[self getPhotoFilePath],[self getPhotoFilePath]];
    [mywebView stringByEvaluatingJavaScriptFromString:jsCommand];
}
...
-(void)pushNotificationReceived:(NSNotification *)notification{
    ...
    NSDictionary *aps = [ss objectForKey:@"aps"];
    NSString *alert = [aps objectForKey:@"alert"];
   
    NSError *error;
    @try {
        NSDictionary *msg = [NSJSONSerialization JSONObjectWithData:[alert dataUsingEncoding:NSUTF8StringEncoding] options:kNilOptions error:&error];
    ...
    //NSString *jsCommand = [NSString stringWithFormat:@"CBPushMessage('%@');",[alert objectForKey:@"msg"]];
    //[mywebView stringByEvaluatingJavaScriptFromString:jsCommand];
}*/
#pragma mark
#pragma mark SMS
