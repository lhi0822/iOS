...
-(void)connectionDidFinishLoading:(NSURLConnection *)connection{
    ...
    if (progressTag < _downloadUrlArray.count-1) {
        ...
        UIAlertView *alertView = [[UIAlertView alloc]initWithTitle:@"Download" message:@"Completed" delegate:self cancelButtonTitle:NSLocalizedString(@"message51", @"확인") otherButtonTitles: nil];
        [alertView show];
    }
}
#pragma mark
