...
- (void)viewDidLoad
{
    ...
    NSString *urlAdderess = @"https://app.kdgas.co.kr:443/dataservice41";
//    NSString *urlAdderess = @"https://roms.dbvalley.com/dataservice41";
