...
- (void)viewDidLoad
{
    ...
    if (bgImage==nil) {
        _imageView.image = [UIImage imageNamed:@"KD-login.png"];
    }else{
    ...
    connButton.layer.cornerRadius = connButton.frame.size.width/30;
...
-(IBAction)TestConnection{
    ...
    if (!isButton) {
        ...
        NSString *mainUrl;
        if([portField.text isEqualToString:@""]) portField.text = @"443";
