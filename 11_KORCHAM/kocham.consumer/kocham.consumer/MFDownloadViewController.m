...
@interface MFDownloadViewController (){
...
@implementation MFDownloadViewController
...
- (void)viewDidLoad
{
    ...
    label.textColor = [MFUtil myRGBfromHex:self.naviFontColor];
    label.text = @"Download";
    ...
    NSData *decryptData = [[NSData dataWithContentsOfFile:self.backGroundImagePath] AES256DecryptWithKey:[MFUtil getAES256Key]];
    UIImage *bgImage = [UIImage imageWithData:decryptData];
    _imageView.image = bgImage;
    _tableView.delegate = self;
    _tableView.separatorColor = [MFUtil myRGBfromHex:self.fontColor];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    label2.textColor = [MFUtil myRGBfromHex:self.fontColor];
    ...
    webAppProgressBar.progressTintColor = [MFUtil myRGBfromHex:self.fontColor];
...
-(void)connectionDidFinishLoading:(NSURLConnection *)connection{
    ...
    [fileData writeToFile:self.saveFilePath atomically:YES];
