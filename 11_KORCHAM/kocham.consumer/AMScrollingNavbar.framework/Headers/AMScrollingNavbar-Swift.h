...
/**
  ...
  <ul>
    ...
    <li>
      scrolling: the navigation bar is transitioning to either \code
      Collapsed
      \endcode or \code
      Scrolling
      \endcode
...
/**
  ...
  \endcode that enables the scrolling of the navigation bar alongside the
...
/**
  ...
  the view’s size. Defaults to \code
  false
  \endcode
*/
...
/**
  ...
  \param delay The delay expressed in points that determines the scrolling resistance. Defaults to \code
  0
  \endcode
...
/**
  ...
  \param animated If true the scrolling is animated. Defaults to \code
  true
  \endcode
...
/**
  UIGestureRecognizerDelegate function. Only scrolls the navigation bar with the content when \code
  scrollingEnabled
  \endcode is true
*/
...
/**
  A custom \code
  UIViewController
  \endcode that implements the base configuration.
*/
...
/**
  On appear calls \code
  showNavbar()
  \endcode by default
*/
- (void)viewWillDisappear:(BOOL)animated;
/**
  On disappear calls \code
  stopFollowingScrollView()
  \endcode to stop observing the current scroll view, and perform the tear down
*/
